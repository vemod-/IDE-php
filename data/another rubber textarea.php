...
*/
  t1.style.width=t1.scrollWidth;
  t1.style.height=t1.scrollHeight;
...
<textarea id='txt1' rows='1' cols='1' WRAP='OFF' style='min-width:100%;min-height:100%;overflow:hidden;border:1px solid;padding:0px;margin:0px;'></textarea>
<div>
</form>
</body>
</html>